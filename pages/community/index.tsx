...
const Community: NextPage = () => {
  return (
    <div className='py-16 px-4 space-y-8'>
      {[...Array(10)].map((_, i) => {
        return (
          <div key={i} className='flex cursor-pointer flex-col items-start'>
            ...
            <div className='pt-5 flex items-center justify-between w-full text-gray-500 font-medium text-xs'>
              <span>진호</span>
              <span>18시간 전</span>
            </div>
      ...
      <button className='fixed hover:bg-orange-500 transition-colors bottom-24 right-5 bg-orange-400 rounded-full shadow-xl p-4 text-white'>
