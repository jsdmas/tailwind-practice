      ...
      <div className='fixed w-full mx-auto max-w-md bottom-2 inset-x-0'>
        <div className='flex relative items-center'>
          ...
          <div className='absolute inset-y-0 flex py-1.5 pr-1.5 right-0'>
            <button className='flex items-center bg-orange-500 rounded-full px-3 hover:bg-orange-600 text-sm text-white focus:ring-2 focus:ring-offset-2 focus:ring-orange-500'>&rarr;</button>
          </div>
        </div>
      </div>
    </div>
